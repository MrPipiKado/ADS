...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        verticalLayout->addLayout(graph);

        diagramWidget = new QWidget(centralwidget);
        diagramWidget->setObjectName(QString::fromUtf8("diagramWidget"));

        verticalLayout->addWidget(diagramWidget);
